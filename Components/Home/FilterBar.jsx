...
const FilterBar = (props) => {
  ...
  const uniqueCategories = [
    ...new Set(tweets.map((tweet) => tweet.SubCategory)),
  ];
  CategoryType = CategoryType.filter((category) =>
    uniqueCategories.includes(category.name)
  );
  ...
  const influNames = [
    ...new Map(influs.map((item) => [item["id"], item])).values(),
  ];
  // useStates
